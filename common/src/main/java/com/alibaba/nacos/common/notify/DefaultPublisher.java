 ...
 *
 * <p>
 * Internally, use {@link ArrayBlockingQueue <Event/>} as a message staging
 * queue.
 *
...
public class DefaultPublisher extends Thread implements EventPublisher {
	...
	void openEventHandler() {
		try {
			...
			// This variable is defined to resolve the problem which message overstock in
			// the queue.
			int waitTimes = 60;
...
//			}
	...
	void receiveEvent(Event event) {
		...
		for (Subscriber subscriber : subscribers) {
			...
			// Because unifying smartSubscriber and subscriber, so here need to think of
			// compatibility.
