...
public class NotifyCenter {
	...
	/**
	 * Register a Subscriber. If the Publisher concerned by the Subscriber does not
	 * exist, then PublihserMap will preempt a placeholder Publisher with default
	...
	/**
	 * Register a Subscriber. If the Publisher concerned by the Subscriber does not
	 * exist, then PublihserMap will preempt a placeholder Publisher with specified
	 * EventPublisherFactory first.
	 *
	 * @param consumer subscriber
	...
	public static void registerSubscriber(final Subscriber consumer, final EventPublisherFactory factory) {
		...
		// based on subclass's subscribeTypes method return list, it can register to
		// publisher.
	 ...
	 * Start () only when the event is actually published.
	 *
